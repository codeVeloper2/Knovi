...
function MobileHeader() {
  ...
  return (
    <div className="fr-mob-header">
      <div className="fr-mob-header-left">
        <button className="fr-mob-menu-btn" aria-label="Open menu"
        ...
        <span className="fr-mob-logo">
          Peer<span className="fr-mob-accent">Up</span>
        </span>
      </div>
      <div className="fr-mob-header-right">
        <NotificationsBell className="fr-mob-bell notif-bell-btn" />
        <button className="fr-mob-avatar" onClick={() => navigate("/app/settings")} aria-label="Profile">
          {photo
