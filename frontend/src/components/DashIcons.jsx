/* Line icons for the dashboard sidebar + UI. */
const base = {
  width: 20,
  height: 20,
  viewBox: "0 0 24 24",
...
/* Upskilling — trending-up arrow with a star spark: distinct from the open-book LearningIcon */
export const UpSkillingIcon = (p) => (
